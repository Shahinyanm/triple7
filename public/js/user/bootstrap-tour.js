  ...
  Tour = (function() {
    function Tour(options) {
      ...
      this._options = $.extend({
        ...
        delay: false,
        basePath: '',
        template: '<div class="popover" role="tooltip"> <div class="arrow"></div> <h3 class="popover-header"></h3> <div class="popover-body"></div> <div class="popover-navigation"> <div class="btn-group"> <button class="btn btn-sm btn-secondary" data-role="prev"><i class="fa fa-angle-left"></i></button> <button class="btn btn-sm btn-secondary" data-role="next"><i class="fa fa-angle-right"></i></button> <button class="btn btn-sm btn-secondary" data-role="pause-resume" data-pause-text="Pause" data-resume-text="Resume">Pause</button> </div> <button class="btn btn-sm btn-secondary" data-role="end"><i class="fa fa-close"></i></div> </div>',
    ...
    Tour.prototype.hideStep = function(i, iNext) {
      ...
      hideStepHelper = (function(_this) {
        return function(e) {
          ...
          $element.popover('hide').removeClass("tour-" + _this._options.name + "-element tour-" + _this._options.name + "-" + i + "-element").removeData('bs.popover');
          if (step.reflex) {

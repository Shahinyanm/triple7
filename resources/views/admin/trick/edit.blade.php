        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-primary" data-collapsed="0">
                ...
                <div class="panel-body">
                    ...
                    <form method="post" role="form" class="form-horizontal form-groups-bordered" action="{{route('admin.tricks.update', $trick->id)}}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        @if($trick)
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group">
                                        <input class="form-check-input" type="checkbox" name="activated" id="activated" @if($trick->activated) checked @endif>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" value="{{$trick->description1}}" name ='description1'>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group">
                                        <span class="input-group-addon"></span>
                                        <input type="text" class="form-control" value="{{$trick->description1}}" name ='description2'>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group">
                                        <span class="input-group-addon"></span>
                                        <input type="text" class="form-control" value="{{$trick->description1}}" name ='description3'>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group">
                                        <span class="input-group-addon"></span>
                                        <input type="text" class="form-control" value="{{$trick->description1}}" name ='description4'>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group">
                                        <span class="input-group-addon"></span>
                                        <input type="number" step="0.01" class="form-control" value="{{$trick->amount}}" name ='amount'>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
